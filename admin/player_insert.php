...
<div class="flex gap-10 mb-3">
  ...
  <h1 class=" font-bold text-xl self-center">Formulario para insertar jugador</h1>
</div>
...
<form method="post" class="space-y-4 mb-4">
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <div>
      <label for="name" class="block overflow-hidden rounded-md border border-gray-200 px-3 py-2 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600">
        ...
        <input type="text" id="name" placeholder="Nombre del jugador" name="name" class="mt-1 w-full border-none p-0 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" required />
      </label>
    </div>
    ...
    <div>
      <label for="last_name" class="block overflow-hidden rounded-md border border-gray-200 px-3 py-2 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600">
        ...
        <input type="text" id="last_name" placeholder="Apellido del jugador" name="last_name" class="mt-1 w-full border-none p-0 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" required />
      </label>
    </div>
  </div>
  <div class="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
    ...
    <div>
      <label for="picture" class="block overflow-hidden rounded-md border border-gray-200 px-3 py-2 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600">
        ...
        <input type="text" id="picture" placeholder="Link de foto del jugador" name="picture" class="mt-1 w-full border-none p-0 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" required />
      </label>
    </div>
  </div>
  ...
  <div class="mt-4 flex justify-between">
    <button type="submit" class="inline-flex w-full items-center justify-center rounded-lg bg-black px-5 py-2 text-white sm:w-auto" name="insert_player">
      <span class="font-medium"> Guardar jugador </span>
