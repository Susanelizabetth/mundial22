...
<div class="flex justify-between mb-2">
  <h1 class=" font-bold text-xl self-center">Tabla de usuarios</h1>
  <a name="insert" id='insert' class="inline-block rounded border border-emerald-700 bg-emerald-700 px-5 py-2 text-sm font-medium text-white hover:bg-transparent hover:text-emerald-700 focus:outline-none focus:ring active:text-emerald-700" href="user_insert.php">
    Ingresar usuario
  </a>
    ...
    <tbody class="divide-y divide-gray-200">
      ...
      ?>
          <tr>
            ...
            <td class='whitespace-nowrap px-4 py-2 text-gray-700'><?php echo $last_name ?></td>
            ...
            <td class='whitespace-nowrap px-4 py-2 text-gray-700'><a href='user_delete.php?id=<?php echo $row["id"] ?>' class='inline-block rounded border border-rose-600 bg-rose-600 px-2 py-2 text-sm font-medium text-white hover:bg-transparent hover:text-rose-600 focus:outline-none focus:ring active:text-rose-500'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
