  ...
  <div class="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
    <div>
      <label for="datetime" class="block overflow-hidden rounded-md border border-gray-200 px-3 py-2 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600">
        ...
        <input type="datetime-local" id="datetime" name="datetime" class="mt-1 w-full border-none p-0 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" required />
      </label>
  ...
  <div class="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
    ...
    <div>
      <label for="gol_team_a" class="block overflow-hidden rounded-md border border-gray-200 px-3 py-2 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600">
        ...
        <input type="number" placeholder="Goles del equipo A" id="gol_team_a" name="gol_team_a" class="mt-1 w-full border-none p-0 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" />
      </label>
    </div>
    ...
    <div>
      <label for="gol_team_b" class="block overflow-hidden rounded-md border border-gray-200 px-3 py-2 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600">
        ...
        <input type="number" placeholder="Goles del equipo B" id="gol_team_b" name="gol_team_b" class="mt-1 w-full border-none p-0 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" />
      </label>
    </div>
  </div>
